...
class SignUpVarification extends StatefulWidget {
  const SignUpVarification({super.key});
  static const String Path = "/SignUpVarification";

  @override
  State<SignUpVarification> createState() => _SignupVerificationState();
}

class _SignupVerificationState extends State<SignUpVarification> {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Enter Sign Up Varification Code",
                  style: TextStyle(
                      color: Colors.black,
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).pushNamed(SignupForm.path);
                    print("object");
                  },
                  child: Container(
